              ...
              <div class="col-lg-11">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"><i class="fas fa-users"></i>  Login Admin</h1>
                  </div>
                  <form class="user" method="post" action="<?php echo base_url('login/cekuser') ?>">
                  ...
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url('login/daftar') ?>">Create an Account!</a>
                  </div> -->
                </div>
              </div>
            </div>
